// app/docs/spotify/page.tsx
// Documentação do endpoint Spotify

import CodeBlock from '@/components/CodeBlock';

export default function DocsSpotifyPage() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-white mb-4">Spotify 🎵</h1>
        <p className="text-xl text-gray-400">
          Busca e download de músicas do Spotify
        </p>
      </div>

      {/* Buscar Música */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Buscar Música</h2>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <code className="text-purple-400">/api/spotify/search</code>
          </div>
        </div>

        <p className="text-gray-400 mb-4">
          Busca músicas no Spotify por nome, artista ou URL.
        </p>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-800">
              <tr>
                ...
                <td className="px-4 py-3 text-gray-400 text-sm">Nome da música, artista ou URL</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  "data": {
    "tracks": [
      ...
      {/* Download */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Download de Música</h2>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <code className="text-purple-400">/api/spotify/download</code>
          </div>
        </div>

        <p className="text-gray-400 mb-4">
          Faz download da música em formato MP3 de alta qualidade.
        </p>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-800">
              <tr>
                ...
                <td className="px-4 py-3 text-gray-400 text-sm">string</td>
                <td className="px-4 py-3 text-green-400 text-sm">Sim</td>
                <td className="px-4 py-3 text-gray-400 text-sm">URL da música no Spotify</td>
              </tr>
            </tbody>
          </table>
        </div>
...
console.log(data.data.download_url);`}
  ...
  "data": {
    "download_url": "https://storage.alauda.mz/downloads/spotify/abc123.mp3",
    ...
    "credits_remaining": 4900
      ...
      {/* Qualidade */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">Qualidade do Áudio</h2>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-semibold">Formato: MP3</p>
                <p className="text-gray-400 text-sm">Compatível com todos os dispositivos</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-400 text-xl">✓</span>
              <div>
                <p className="text-white font-semibold">Bitrate: 320kbps</p>
                <p className="text-gray-400 text-sm">Alta qualidade de áudio</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-400 text-xl">✓</span>
              <div>
                ...
                <p className="text-gray-400 text-sm">Título, artista, álbum e capa</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-4">
        <div className="bg-yellow-500/10 border border-yellow-500/50 rounded-lg p-4">
          <div className="flex gap-3">
            ...
            <div>
              <h3 className="text-yellow-400 font-semibold mb-1">Aviso Legal</h3>
              <p className="text-gray-300 text-sm">
                Esta API deve ser usada apenas para fins educacionais e de teste. 
                Respeite os direitos autorais e as políticas do Spotify.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/50 rounded-lg p-4">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                Use a busca primeiro para encontrar a URL correta da música antes de fazer o download.
              </p>
            </div>
          </div>
        </div>
